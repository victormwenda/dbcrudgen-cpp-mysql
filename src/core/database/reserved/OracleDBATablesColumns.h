...
#ifndef DBCRUDGEN_CPP_ORACLEDBATABLESCOLUMNS_H
#define DBCRUDGEN_CPP_ORACLEDBATABLESCOLUMNS_H


//
// OracleDBATablesColumns
// //
class OracleDBATablesColumns {
public:
    struct OWNER {
...
#endif //DBCRUDGEN_CPP_ORACLEDBATABLESCOLUMNS_H
