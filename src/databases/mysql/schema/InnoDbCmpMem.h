...
#ifndef DBCRUDGEN_CPP_INNODBCMPMEM_H
#define DBCRUDGEN_CPP_INNODBCMPMEM_H
...
namespace dbcrudgen {
    namespace mysql {
        ...
        public:
            ...
            static constexpr const char *TABLE_NAME = "INNODB_CMPMEM";
            ...
            InnoDbCmpMem(int pageSize, int bufferPoolInstance, int pagesUsed, int pagesFree, long relocationOps,
                         int relocationTime) : pageSize{pageSize}, bufferPoolInstance{bufferPoolInstance},
                                               pagesUsed{pagesUsed}, pagesFree{pagesFree}, relocationOps{relocationOps},
            ...
            /**
            * Returns the table name 'INNODB_CMPMEM';
            */
...
#endif //DBCRUDGEN_CPP_INNODBCMPMEM_H
