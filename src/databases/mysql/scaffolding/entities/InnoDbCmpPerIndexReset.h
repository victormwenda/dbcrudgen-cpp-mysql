        ...
        namespace mysql {
            ...
            public:
                ...
                InnoDbCmpPerIndexReset(std::string
                                       ...
                                       int uncompressOps,
                                       int uncompressTime
                ) : databaseName{databaseName}, tableName{tableName}, indexName{indexName}, compressOps{compressOps},
                    compressOpsOk{compressOpsOk}, compressTime{compressTime}, uncompressOps{uncompressOps},
