...
#ifndef DBCRUDGEN_CPP_INNODBCMPPERINDEX_H
#define DBCRUDGEN_CPP_INNODBCMPPERINDEX_H
    ...
    namespace db {
        namespace mysql {
            ...
            public:
                ...
                static constexpr const char *TABLE_NAME = "INNODB_CMP_PER_INDEX";
                ...
                InnoDbCmpPerIndex(std::string &databaseName, std::string &tableName, std::string &indexName,
                                  int compressOps, int compressOpsOk, int compressTime, int uncompressOps,
                                  int uncompressTime) : databaseName{databaseName}, tableName{tableName},
                                                        indexName{indexName}, compressOps{compressOps},
                ...
                /**
                * Returns the table name 'INNODB_CMP_PER_INDEX';
                */
...
#endif //DBCRUDGEN_CPP_INNODBCMPPERINDEX_H
