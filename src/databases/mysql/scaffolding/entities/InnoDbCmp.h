...
#ifndef DBCRUDGEN_CPP_INNODBCMP_H
#define DBCRUDGEN_CPP_INNODBCMP_H
...
namespace dbcrudgen {
    namespace mysql {
        ...
        public:
            ...
            static constexpr const char *TABLE_NAME = "INNODB_CMP";
            ...
            InnoDbCmp(int pageSize, int compressOps, int compressOpsOk, int compressTime, int uncompressOps,
                      int uncompressTime) : pageSize{pageSize}, compressOps{compressOps}, compressOpsOk{compressOpsOk},
                                            compressTime{compressTime}, uncompressOps{uncompressOps},
            ...
            /**
            * Returns the table name 'INNODB_CMP';
            */
...
#endif //DBCRUDGEN_CPP_INNODBCMP_H
