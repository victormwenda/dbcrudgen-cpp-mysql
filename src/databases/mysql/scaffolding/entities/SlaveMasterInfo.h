    ...
    namespace mysql {
        ...
        public:
            ...
            SlaveMasterInfo(int numberOfLines, std::string &masterLogName, long masterLogPos, std::string &host,
                            ...
                            std::string &sslCipher, std::string &sslKey, int sslVerifyServerCert, long double heartbeat,
                    ...
                    : numberOfLines{numberOfLines}, masterLogName{masterLogName}, masterLogPos{masterLogPos},
                      ...
                      sslCert{sslCert}, sslCipher{sslCipher}, sslKey{sslKey}, sslVerifyServerCert{sslVerifyServerCert},
