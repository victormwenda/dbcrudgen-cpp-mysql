        ...
        namespace mysql {
            ...
            public:
                ...
                Profiling(int queryId, int seq, std::string &state, long duration, long cpuUser, long cpuSystem,
                          int contextVoluntary, int contextInvoluntary, int blockOpsIn, int blockOpsOut,
                          int messagesSent,
                        ...
                        : queryId{queryId}, seq{seq}, state{state}, duration{duration}, cpuUser{cpuUser},
                          cpuSystem{cpuSystem}, contextVoluntary{contextVoluntary},
                          contextInvoluntary{contextInvoluntary},
