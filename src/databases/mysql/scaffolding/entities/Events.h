    ...
    namespace db {
        namespace mysql {
            ...
            public:
                ...
                Events(std::string &eventCatalog, std::string &eventSchema, std::string &eventName,
                       std::string &definer,
                       std::string &timeZone, std::string &eventBody, std::string &eventDefinition,
                       std::string &eventType,
                       std::string &executeAt, std::string &intervalValue, std::string &intervalField,
                       std::string &sqlMode,
                       std::string &starts, std::string &ends, std::string &status, std::string &onCompletion,
                       std::string &created, std::string &lastAltered, std::string &lastExecuted,
                       std::string &eventComment,
