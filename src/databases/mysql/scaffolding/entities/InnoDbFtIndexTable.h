    ...
    namespace db {
        namespace mysql {
            ...
            public:
                ...
                static constexpr const char *TABLE_NAME = "INNODB_FT_INDEX_TABLE";
                ...
                InnoDbFtIndexTable(std::string &word, long firstDocId, long lastDocId, long docCount, long docId,
                ...
                /**
                * Returns the table name 'INNODB_FT_INDEX_TABLE';
                */
