    ...
    namespace db {
        namespace mysql {
            ...
            public:
                ...
                Db(std::string &host, std::string &db, std::string &user, std::string &selectPriv,
                   std::string &insertPriv,
                   ...
                   std::string &executePriv, std::string &eventPriv, std::string &triggerPriv)
                        : host{host}, db{db}, user{user}, selectPriv{selectPriv}, insertPriv{insertPriv},
                          ...
                          grantPriv{grantPriv}, referencesPriv{referencesPriv}, indexPriv{indexPriv},
                          alterPriv{alterPriv},
                          createTmpTablePriv{createTmpTablePriv}, lockTablesPriv{lockTablesPriv},
                          createViewPriv{createViewPriv}, showViewPriv{showViewPriv},
