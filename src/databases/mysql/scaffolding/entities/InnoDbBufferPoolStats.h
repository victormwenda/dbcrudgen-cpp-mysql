        ...
        namespace mysql {
            ...
            public:
                ...
                InnoDbBufferPoolStats(long poolId, long poolSize, long freeBuffers, long databasePages,
                                      ...
                                      long pendingReads, long pendingFlushLru, long pendingFlushList,
                                      long pagesMadeYoung, long pagesNotMadeYoung, long double pagesMadeYoungRate,
                                      ...
                                      long uncompressTotal, long uncompressCurrent)
                        : poolId{poolId}, poolSize{poolSize}, freeBuffers{freeBuffers}, databasePages{databasePages},
                          oldDatabasePages{oldDatabasePages}, modifiedDatabasePages{modifiedDatabasePages},
                          pendingDecompress{pendingDecompress}, pendingReads{pendingReads},
                          pendingFlushLru{pendingFlushLru}, pendingFlushList{pendingFlushList},
                          pagesMadeYoung{pagesMadeYoung}, pagesNotMadeYoung{pagesNotMadeYoung},
                          pagesMadeYoungRate{pagesMadeYoungRate}, pagesMadeNotYoungRate{pagesMadeNotYoungRate},
                          numberPagesRead{numberPagesRead}, numberPagesCreated{numberPagesCreated},
                          numberPagesWritten{numberPagesWritten}, pagesReadRate{pagesReadRate},
                          pagesCreateRate{pagesCreateRate}, pagesWrittenRate{pagesWrittenRate},
                          numberPagesGet{numberPagesGet}, hitRate{hitRate},
                          youngMakePerThousandGets{youngMakePerThousandGets},
                          notYoungMakePerThousandGets{notYoungMakePerThousandGets},
                          numberPagesReadAhead{numberPagesReadAhead}, numberReadAheadEvicted{numberReadAheadEvicted},
                          readAheadRate{readAheadRate}, readAheadEvictedRate{readAheadEvictedRate},
                          lruIoTotal{lruIoTotal}, lruIoCurrent{lruIoCurrent}, uncompressTotal{uncompressTotal},
                          uncompressCurrent{uncompressCurrent} {}
