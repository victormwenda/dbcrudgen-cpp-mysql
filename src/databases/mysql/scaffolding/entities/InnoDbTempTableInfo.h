...
namespace dbcrudgen {
    namespace mysql {
        ...
        public:
            ...
            InnoDbTempTableInfo(long tableId, std::string &name, int nCols, int space, std::string &perTableTablespace,
                                std::string &isCompressed) : tableId{tableId}, name{name}, nCols{nCols}, space{space},
