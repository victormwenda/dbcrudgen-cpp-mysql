        ...
        namespace mysql {
            ...
            public:
                ...
                Files(long fileId, std::string &fileName, std::string &fileType, std::string &tablespaceName,
                      ...
                      std::string &fulltextKeys, long deletedRows, long updateCount, long freeExtents,
                      long totalExtents,
                      long extentSize, long initialSize, long maximumSize, long autoextendSize,
                      std::string &creationTime,
                      std::string &lastUpdateTime, std::string &lastAccessTime, long recoverTime,
                      long transactionCounter,
