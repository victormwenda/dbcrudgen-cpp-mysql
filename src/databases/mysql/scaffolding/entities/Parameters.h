    ...
    namespace mysql {
        ...
        public:
            ...
            Parameters(std::string &specificCatalog, std::string &specificSchema, std::string &specificName,
                       ...
                       long numericPrecision, int numericScale, long datetimePrecision, std::string &characterSetName,
                    ...
                    : specificCatalog{specificCatalog}, specificSchema{specificSchema}, specificName{specificName},
                      ...
                      characterSetName{characterSetName}, collationName{collationName}, dtdIdentifier{dtdIdentifier},
