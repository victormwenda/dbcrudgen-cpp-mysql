                ...
                */
                std::vector<SysDatabases> getSysDatabases() {
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::DATABASE_ID::INDEX, SQL_C_CHAR, columnName,
                                               database_id, 255, &database_id_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::SOURCE_DATABASE_ID::INDEX, SQL_C_CHAR, columnName,
                                               source_database_id, 255, &source_database_id_indicator});
                    }
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::USER_ACCESS::INDEX, SQL_C_CHAR, columnName,
                                               user_access, 255, &user_access_indicator});
                    }
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_READ_ONLY::INDEX, SQL_C_CHAR, columnName,
                                               is_read_only, 255, &is_read_only_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_AUTO_CLOSE_ON::INDEX, SQL_C_CHAR, columnName,
                                               is_auto_close_on, 255, &is_auto_close_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_AUTO_SHRINK_ON::INDEX, SQL_C_CHAR, columnName,
                                               is_auto_shrink_on, 255, &is_auto_shrink_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::STATE::INDEX, SQL_C_CHAR, columnName, state, 255,
                                               &state_indicator});
                    }
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_IN_STANDBY::INDEX, SQL_C_CHAR, columnName,
                                               is_in_standby, 255, &is_in_standby_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_CLEANLY_SHUTDOWN::INDEX, SQL_C_CHAR,
                                               columnName, is_cleanly_shutdown, 255, &is_cleanly_shutdown_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_SUPPLEMENTAL_LOGGING_ENABLED::INDEX,
                                               SQL_C_CHAR, columnName, is_supplemental_logging_enabled, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_READ_COMMITTED_SNAPSHOT_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_read_committed_snapshot_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_AUTO_CREATE_STATS_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_auto_create_stats_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_AUTO_CREATE_STATS_INCREMENTAL_ON::INDEX,
                                               SQL_C_CHAR, columnName, is_auto_create_stats_incremental_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_AUTO_UPDATE_STATS_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_auto_update_stats_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_AUTO_UPDATE_STATS_ASYNC_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_auto_update_stats_async_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_ANSI_NULL_DEFAULT_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_ansi_null_default_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_ANSI_NULLS_ON::INDEX, SQL_C_CHAR, columnName,
                                               is_ansi_nulls_on, 255, &is_ansi_nulls_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_ANSI_PADDING_ON::INDEX, SQL_C_CHAR, columnName,
                                               is_ansi_padding_on, 255, &is_ansi_padding_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_ANSI_WARNINGS_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_ansi_warnings_on, 255, &is_ansi_warnings_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_ARITHABORT_ON::INDEX, SQL_C_CHAR, columnName,
                                               is_arithabort_on, 255, &is_arithabort_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_CONCAT_NULL_YIELDS_NULL_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_concat_null_yields_null_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_NUMERIC_ROUNDABORT_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_numeric_roundabort_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_QUOTED_IDENTIFIER_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_quoted_identifier_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_RECURSIVE_TRIGGERS_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_recursive_triggers_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_CURSOR_CLOSE_ON_COMMIT_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_cursor_close_on_commit_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_LOCAL_CURSOR_DEFAULT::INDEX, SQL_C_CHAR,
                                               columnName, is_local_cursor_default, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_FULLTEXT_ENABLED::INDEX, SQL_C_CHAR,
                                               columnName, is_fulltext_enabled, 255, &is_fulltext_enabled_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_TRUSTWORTHY_ON::INDEX, SQL_C_CHAR, columnName,
                                               is_trustworthy_on, 255, &is_trustworthy_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_DB_CHAINING_ON::INDEX, SQL_C_CHAR, columnName,
                                               is_db_chaining_on, 255, &is_db_chaining_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_PARAMETERIZATION_FORCED::INDEX, SQL_C_CHAR,
                                               columnName, is_parameterization_forced, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_MASTER_KEY_ENCRYPTED_BY_SERVER::INDEX,
                                               SQL_C_CHAR, columnName, is_master_key_encrypted_by_server, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_QUERY_STORE_ON::INDEX, SQL_C_CHAR, columnName,
                                               is_query_store_on, 255, &is_query_store_on_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_PUBLISHED::INDEX, SQL_C_CHAR, columnName,
                                               is_published, 255, &is_published_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_SUBSCRIBED::INDEX, SQL_C_CHAR, columnName,
                                               is_subscribed, 255, &is_subscribed_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_MERGE_PUBLISHED::INDEX, SQL_C_CHAR, columnName,
                                               is_merge_published, 255, &is_merge_published_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_DISTRIBUTOR::INDEX, SQL_C_CHAR, columnName,
                                               is_distributor, 255, &is_distributor_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_SYNC_WITH_BACKUP::INDEX, SQL_C_CHAR,
                                               columnName, is_sync_with_backup, 255, &is_sync_with_backup_indicator});
                    }
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_BROKER_ENABLED::INDEX, SQL_C_CHAR, columnName,
                                               is_broker_enabled, 255, &is_broker_enabled_indicator});
                    }
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_DATE_CORRELATION_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_date_correlation_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_CDC_ENABLED::INDEX, SQL_C_CHAR, columnName,
                                               is_cdc_enabled, 255, &is_cdc_enabled_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_ENCRYPTED::INDEX, SQL_C_CHAR, columnName,
                                               is_encrypted, 255, &is_encrypted_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_HONOR_BROKER_PRIORITY_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_honor_broker_priority_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_NESTED_TRIGGERS_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_nested_triggers_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_TRANSFORM_NOISE_WORDS_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_transform_noise_words_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT_ON::INDEX,
                                               SQL_C_CHAR, columnName, is_memory_optimized_elevate_to_snapshot_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_FEDERATION_MEMBER::INDEX, SQL_C_CHAR,
                                               columnName, is_federation_member, 255, &is_federation_member_indicator});
                    }

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_REMOTE_DATA_ARCHIVE_ENABLED::INDEX, SQL_C_CHAR,
                                               columnName, is_remote_data_archive_enabled, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_MIXED_PAGE_ALLOCATION_ON::INDEX, SQL_C_CHAR,
                                               columnName, is_mixed_page_allocation_on, 255,
...

                    {
                        ...
                        colBindings.emplace_back(
                                MSSQLColBinder{SysDatabases::COLUMNS::IS_TEMPORAL_HISTORY_RETENTION_ENABLED::INDEX,
                                               SQL_C_CHAR, columnName, is_temporal_history_retention_enabled, 255,
                    ...
                    for (const dbcrudgen::db::mssql::MSSQLResultSet &data: resultSet) {
                        ...
                        switch (data.getColumnIndex()) {
                            ...
                            std::cout << "Col value: " << name << std::endl;
                                break;
