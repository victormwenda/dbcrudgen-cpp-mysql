...
public:
    ...
    OracleDBATables(std::string owner, std::string table_name, std::string tablespace_name,
                    ...
                    int pct_free, int pct_used, int ini_trans, int max_trans, int initial_extent, int next_extent,
                    ...
                    std::string result_cache) : owner(owner), table_name(table_name),
                                                tablespace_name(tablespace_name), cluster_name(cluster_name),
                                                iot_name(iot_name), status(status), pct_free(pct_free),
                                                pct_used(pct_used), ini_trans(ini_trans), max_trans(max_trans),
                                                ...
                                                cell_flash_cache(cell_flash_cache), row_movement(row_movement),
