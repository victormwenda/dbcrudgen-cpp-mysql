    ...
    namespace orm {
        ...
        public:
            ...
            */
             ...
             * @return
             */
            std::string getAbsoluteWebXMLFilePathSrc(const std::string &filename = "web.xml") {
             ...
             * @return
             */
            std::string getAbsoluteWebXMLFilePathRes(const std::string &filename = "web.xml") {
             ...
             * @return
             */
            std::string getDatabaseConnectionAbsolutePath() {
            ...
            * @return
            */
            std::string getWebApplicationAbsolutePath() {
            ...
            * @return
            */
            std::string getBeansAbsolutePath() {
            ...
            * @return
            */
            std::string getWebApplicationFileAbsolutePath() {
            ...
            * @return
            */
            std::string getDatabaseConnectionFileAbsolutePath() {
