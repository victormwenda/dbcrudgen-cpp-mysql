...
CCFLAGS=$(CCINCLUDES) -DMAC_OSX -D_GNU_SOURCE -D_REENTRANT -g -m64 -mmacosx-version-min=10.11
LDFLAGS=-g -m64 -mmacosx-version-min=10.11
...
LDFLAGS+=-rpath $(ICLIBHOME_FULL_PATH) \
         -rpath @executable_path/../../rdbms/lib \
         -rpath @executable_path/../../ldap/lib \
         -rpath @executable_path/../../opmn/lib \
         -rpath $(ORACLE_HOME)/lib
