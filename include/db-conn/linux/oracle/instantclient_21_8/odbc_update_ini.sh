#!/bin/sh
#
# $Header: odbc/utl/odbc_update_ini.sh.pp.repos /main/25 2019/07/18 21:48:06 spattnay Exp $
#
# odbc_update_ini.sh
#
...
#
#    MODIFIED   (MM/DD/YY)
#    spattnay    05/06/19 - Cleanup RDBMS_VERSION
...
#
DRIVER_DESCRIPTION="Oracle ODBC driver for Oracle 21"
...
if [ ! "$3" ]
     then
        DRIVER_NAME="Oracle 21 ODBC driver"
     else
        DRIVER_NAME="$3"
fi
